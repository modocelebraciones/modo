            ...
            {sent ? (
              <div className="reveal is-visible border border-black/10 p-10 md:p-14 text-center">
                ...
                <button
                  ...
                  className="mt-8 text-sm text-ink/70 link-underline"
                >
                  Enviar otro mensaje
                </button>
              </div>
              ...
              <form ref={formRef} onSubmit={onSubmit} className="space-y-2" noValidate>
                ...
                <div className="reveal reveal-d3 pt-6">
                  <button
                    type="submit"
                    className="inline-flex items-center gap-3 bg-ink text-paper px-7 py-4 text-sm tracking-wide hover:bg-olive transition-colors duration-300"
                  >
                    Conversemos
